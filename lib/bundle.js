...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyBindings = __webpack_require__(6);
	...
	document.addEventListener("DOMContentLoaded", function(){
	  ...
	  window.setTimeout(function() {
	    ...
	    $(".controls").click(function (e) {
	      var code = parseInt(e.target.parentElement.id);
	      if (!code) { code = parseInt(e.target.id); }
	      var action = KeyBindings[code];
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.draw = function (ctx) {
	  ...
	  ctx.font = "30px serif";
	  ctx.fillStyle = "#357d23";
	  // show ready sign
	  if (this.playerOne.actions.length === 4) {
	    ctx.fillText("Ready!", 200, 90);
	  }
	  if (this.playerTwo.actions.length === 4) {
	    ctx.fillText("Ready!", 700, 90);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sword = __webpack_require__(4);
